...
| Ethernet5 | dc1-host3_Eth1 | *trunk | *11-12,21-22 | *4092 | *- | 5 |
| Ethernet6 | dc1-host4_Eth1 | *trunk | *11-12,21-22 | *4092 | *- | 6 |
...
!
interface Ethernet5
   description dc1-host3_Eth1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description dc1-host4_Eth1
   no shutdown
...
| Port-Channel5 | dc1-host3_PortChannel dc1-host3 | switched | trunk | 11-12,21-22 | 4092 | - | - | - | 5 | - |
| Port-Channel6 | dc1-host4_PortChannel dc1-host4 | switched | trunk | 11-12,21-22 | 4092 | - | - | - | 6 | - |
...
interface Port-Channel5
   description dc1-host3_PortChannel dc1-host3
   no shutdown
   switchport
...
interface Port-Channel6
   description dc1-host4_PortChannel dc1-host4
   no shutdown
   switchport
   switchport trunk allowed vlan 11-12,21-22
   switchport trunk native vlan 4092
